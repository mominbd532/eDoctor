    		...
    		<div class="row">
    		    <div class="col-md-6 py-5 pr-md-5">
	                <div class="heading-section heading-section-white ftco-animate mb-5">
                        ...
                        <h2 class="mb-4">Login to get appointment</h2>
	                </div>
					<form class="login-form" method="post" action="<?php echo base_url('patientpost/login'); ?>">
						...
						<!-- <div class="form-group m-t-10 mb-0 row">
							<div class="col-12 m-t-20">
								<a href="<?php echo base_url('patient/forgot_password'); ?>" style="color:#ffffff;"><i class="mdi mdi-lock"></i> Forgot your password?</a>
							</div>
						</div> -->
					</form>
    			</div>

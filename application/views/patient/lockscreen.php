            ...
            <div class="card">
                <div class="card-block">
                    ...
                    <div class="p-3">
                        ...
                        <form class="form-horizontal m-t-30" method="post" action="<?php echo base_url('patientpost/login'); ?>">
                            <div class="user-thumb text-center m-b-30">
                            <a href="#" class="logo logo-admin"><img src="<?php echo base_url(); ?>assets/images/<?php echo $this->security->xss_clean(htmlspecialchars($patient_details['profile_photo'])); ?>" height="30" alt="logo"></a>
                                <h6><?php echo $this->security->xss_clean(htmlspecialchars($patient_details['p_name'])); ?></h6>
                            </div>
                            <div class="form-group">
                                <input type="hidden" name="email" value="<?php echo $this->security->xss_clean(htmlspecialchars($patient_details['email'])); ?>">

...
$row_data = $this->security->xss_clean($this->doctor_mo->getprescriptionbyid($id)); ?>
    ...
    <div class="pcoded-content">
        ...
        <?php
            if(!$row_data){
                ...
                $data = $row_data;
                $user = $this->patient_mo->getp_name($data['doctor_id']);
        ...
        <div class="page-content-wrapper">
            <div class="">
                <div class="row">
                    <div class="col-12">
                        <div class="m-b-20">                                
                            <a href="<?php echo base_url('doctor/prescription'); ?>"><button type="button" class="btn btn-primary waves-effect waves-light"><i class="fa fa-arrow-left"></i>&nbsp; Back to Prescription List</button></a>                                           

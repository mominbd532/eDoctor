                ...
                <div class="row">
                    <div class="col-12">
                      <div class="m-b-20">
                        ...
                        <div class="modal fade new_appoinment" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="new_appoinment">
                                        ...
                                        <p class="status"></p>
                                            <form class="p-3" method="post">
                                                <div class="form-group row">
                                                    <label for="patient" class="col-form-label text-muted">Doctor</label>
                                                    <div class="input-group">
                                                        <select class="select2" id="myselect2" name="patient_id" required>
                                                            <option value="">Select</option>
                                                                <?php foreach ( $info as $data ) : ?>
                                                                    <option value="<?php echo $this->security->xss_clean($data['doctor_id']); ?>"><?php echo $this->security->xss_clean($data['doctor_name']); ?></option>
                                                                <?php endforeach; ?>
                                                        </select>
                                                    </div>  
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" name="date" id ="datepicker-autoclosed" value="<?php echo date('Y-m-d'); ?>" />

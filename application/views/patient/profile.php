            ...
            <div class="">
                <div class="row">
                    <div class="col-6">
                        <div class="card m-b-20">
                            <div class="card-block">
                                ...
                                <form name="updateprofile" id="updateprofile" method="post" action="<?php echo base_url('patientpost/update_profile'); ?>">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="p_name" value="<?php echo $this->security->xss_clean(htmlspecialchars($patient_details['p_name'])) ?>" placeholder="Patient Name" required="">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                               
                                                <input type="email" class="form-control" name="email" value="<?php echo $this->security->xss_clean(htmlspecialchars($patient_details['email'])) ?>" placeholder="Patient Email" required="">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="phone" value="<?php echo 
                                                    $this->security->xss_clean($patient_details['phone']) ?>" placeholder="Patient Phone" required="">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                    ...
                    <div class="col-6">
                        <div class="card m-b-20">
                            <div class="card-block">
                                <label><h6>Profile Information</h6></label>
                                <form name="updatepassword" id="updatepassword" method="post" action="<?php echo base_url('patientpost/update_password'); ?>">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="card m-b-20">
                            <div class="card-block">
                                <form name="updatelogo" id="updatelogo" method="post" action="<?php echo base_url('patientpost/update_photo'); ?>" enctype="multipart/form-data">
                                    <div class="row">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <input type="file" name="profile_photo" class="dropify" data-default-file="<?php echo base_url(); ?>assets/images/<?php echo $this->security->xss_clean(htmlspecialchars($patient_details['profile_photo'])); ?>"  />
                                        </div>
                                    </div>
                                </form>
                            </div>
    ...
    $(document).ready(function(){
        ...
        $('#changepass').click(function(){
            ...
            if(rpass == npass)
            {
                $.ajax({
                    type:'POST',
                    url:'../patientpost/update_password',
                    dataType:'json',
                    data:{cpass : cpass,
                        npass : npass
                        },

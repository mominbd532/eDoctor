...
<?php 
    ...
    $row_data = $this->admin_mo->getinvoicebyid($id);
?>
<div class="pcoded-main-container">
    <div class="pcoded-content">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    ...
                                                    <?php echo $this->security->xss_clean(htmlspecialchars($user['doctor_designation'])) ?>
                                                    <?php echo $this->security->xss_clean(htmlspecialchars($user['doctor_qualification'])) ?>
                                                    <?php echo $this->security->xss_clean(htmlspecialchars($user['doctor_hospital'])) ?>
        ...
        </div><!-- end page-content-wrapper -->  </div>
                                                                        </div>      

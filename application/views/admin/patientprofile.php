...
<?php include_once('includes/style.php');
    ...
    $appointment = $this->admin_mo->get_appointment($id);
    $prescription = $this->admin_mo->get_prescription($id);
    $invoice = $this->admin_mo->get_invoice($id);
?>
        ...
        <div class="page-content-wrapper">
            <div class="">
                <div class="row">
                    <div class="col-12">
                        <div class="m-b-20">
                        <a href="<?php echo base_url('admin/patients'); ?>"><button type="button" class="btn btn-primary waves-effect waves-light"><i class="fa fa-arrow-left"></i>&nbsp; Back to Patient List</button></a>
                        </div>
                    </div>
                </div><!-- Ends Row -->
                <div class="row">
                                ...
                                <div class="user-bg">
                                    <div class="overlay-box">
                                        <div class="user-content">
                                            ...
                                            <h5 class="text-white"><?php echo $this->security->xss_clean(htmlspecialchars($data[0]['p_name'])) ?></h5>
                                        </div>
                                    </div>
                                </div>
                                <div class="user-btm-box">
                                    <ul class="basic-list">
                                        <li>
                                            ...
                                            <span class="text"><?php echo $this->security->xss_clean(htmlspecialchars($data[0]['p_name'])) ?></span>
                                        </li>
                                        <li>
                                            <b class="title">Age:</b> &nbsp;&nbsp;&nbsp;
                                            <span class="text"><?php echo $this->security->xss_clean(htmlspecialchars($data[0]['age'])) ?></span>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <span class="text"><?php echo $this->security->xss_clean($data[0]['phone']) ?></span>
                                        </li>
                                        <li>
                                            <b class="title">Address:</b> &nbsp;&nbsp;&nbsp;
                                            <span class="text"><?php echo $this->security->xss_clean($data[0]['add']) ?></span>
                                        </li>
                                    </ul>
                                    <a href="<?php echo base_url('admin/editpatient')."/".$id;?>"><button type="button" class="btn btn-primary waves-effect waves-light"><span class="mdi mdi-grease-pencil"></span>&nbsp; Edit</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="tab-pane p-3 active" id="medical" role="tabpanel" aria-expanded="false">
                                        <table class="table table-striped">
                                            <tbody>
                                                <tr>
                                                    <td>Height</td>
                                                    <td><?php echo $this->security->xss_clean(htmlspecialchars($data[0]['height'])) ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Weight</td>
                                                    <td><?php echo $this->security->xss_clean(htmlspecialchars($data[0]['weight'])) ?> kg</td>
                                                </tr>
                                                <tr>
                                                    <td>Blood Group</td>
                                                    <td><?php echo $this->security->xss_clean(htmlspecialchars($data[0]['b_group'])) ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Blood Pressure</td>
                                                    <td><?php echo $this->security->xss_clean(htmlspecialchars($data[0]['b_pressure'])) ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Pulse</td>
                                                    <td><?php echo $this->security->xss_clean(htmlspecialchars($data[0]['pulse'])) ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Respiration</td>
                                                    <td><?php echo $this->security->xss_clean(htmlspecialchars($data[0]['respiration'])) ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Allergy</td>
                                                    <td><?php echo $this->security->xss_clean(htmlspecialchars($data[0]['allergy'])) ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Diet</td>
                                                    <td><?php echo $this->security->xss_clean(htmlspecialchars($data[0]['diet'])) ?></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                        ...
                                        <table class="table table-bordered  datatable-init">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo base_url('admin/print_prescription')."/".$preinfo['prescription_id'];?>"><button type="button" class="btn btn-1d btn-sm btn-outline-primary waves-effect waves-light">Print Prescription</button></td>
                                                </tr>
                                                        <?php 
                                                            $i++;
                                                        endforeach; ?>
                                        ...
                                        <table class="table table-bordered  datatable-init">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $this->security->xss_clean(htmlspecialchars($invoiceinfo['payment_status'])); ?></td>
                                                    <td>
                                                        <a href="<?php echo base_url('admin/print_invoice')."/".

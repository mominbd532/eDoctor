                                        ...
                                        <?php  $i = 1; foreach ( $info as $data ) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="javascript:void(0);" onclick="deletes(<?php echo $data['patient_id'];?>);"><button type="button" class="btn btn-1d btn-sm btn-outline-primary waves-effect waves-light"><span class="mdi mdi-delete"></span></button></a>
                                                <script type="text/javascript">
                                                    var url="<?php echo base_url();?>";
                                                    function deletes(id){
                                                        var r=confirm("Do you want to delete this?")
                                                        if (r==true)
                                                            window.location = url+"adminpost/deletepatient/"+id;
                                                        else
                                                            return false;
                                                    } 
                                                </script>
